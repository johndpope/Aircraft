...
class Map_tc extends EditorWindow
{
	...
	function OnGUI()
	{
		...
		*/
		...
		if (global_script.map.button_parameters || global_script.map.button_region || global_script.map.button_heightmap_export || global_script.map.button_image_export || global_script.map.button_settings || global_script.map.button_image_editor)
		{
		...
		if (current_area.preimage_export_active){GUI.backgroundColor += Color(1,-0.5,-1);}
		...
		if (global_script.map.button_image_editor)
		{	
			image_editor_rect = Rect(0,gui_y,guiWidth2+348,121+((global_script.map.preimage_edit.edit_color.Count*18)+(Convert.ToInt32(current_area.preimage_save_new)*60)+gui_height));
			drawGUIBox(image_editor_rect,"Image Editor",global_script.map.backgroundColor,global_script.map.titleColor,global_script.map.color);
			
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Color Rules",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			EditorGUILayout.EndHorizontal();
			...
			if (GUILayout.Button("-",EditorStyles.miniButtonMid,GUILayout.Width(25)) && global_script.map.preimage_edit.edit_color.Count > 1)
			{
				if (key.control) {
			...
			GUI.changed = false;
			global_script.map.preimage_edit.active = EditorGUILayout.Toggle(global_script.map.preimage_edit.active,GUILayout.Width(25));
			EditorGUILayout.EndHorizontal();
			...
			for (var count_edit_color: int = 0;count_edit_color < global_script.map.preimage_edit.edit_color.Count;++count_edit_color) {
				EditorGUILayout.BeginHorizontal();
				GUILayout.Space(7);
				global_script.map.preimage_edit.edit_color[count_edit_color].color1_start = EditorGUILayout.ColorField (global_script.map.preimage_edit.edit_color[count_edit_color].color1_start,GUILayout.Width(50));
				global_script.map.preimage_edit.edit_color[count_edit_color].color1_end = EditorGUILayout.ColorField (global_script.map.preimage_edit.edit_color[count_edit_color].color1_end,GUILayout.Width(50));
				
				global_script.map.preimage_edit.edit_color[count_edit_color].curve1 = EditorGUILayout.CurveField (global_script.map.preimage_edit.edit_color[count_edit_color].curve1,GUILayout.Width(50));
				global_script.map.preimage_edit.edit_color[count_edit_color].solid_color = EditorGUILayout.Toggle (global_script.map.preimage_edit.edit_color[count_edit_color].solid_color,GUILayout.Width(25));
				
				EditorGUILayout.LabelField("->",EditorStyles.boldLabel,GUILayout.Width(20));
				
				global_script.map.preimage_edit.edit_color[count_edit_color].color2_start = EditorGUILayout.ColorField (global_script.map.preimage_edit.edit_color[count_edit_color].color2_start,GUILayout.Width(50));
				global_script.map.preimage_edit.edit_color[count_edit_color].color2_end = EditorGUILayout.ColorField (global_script.map.preimage_edit.edit_color[count_edit_color].color2_end,GUILayout.Width(50));
				
				global_script.map.preimage_edit.edit_color[count_edit_color].curve2 = EditorGUILayout.CurveField (global_script.map.preimage_edit.edit_color[count_edit_color].curve2,GUILayout.Width(50));
				
				global_script.map.preimage_edit.edit_color[count_edit_color].strength = EditorGUILayout.FloatField (global_script.map.preimage_edit.edit_color[count_edit_color].strength,GUILayout.Width(75));
				
				global_script.map.preimage_edit.edit_color[count_edit_color].output = EditorGUILayout.EnumPopup (global_script.map.preimage_edit.edit_color[count_edit_color].output,GUILayout.Width(75));
				
				global_script.map.preimage_edit.edit_color[count_edit_color].active = EditorGUILayout.Toggle (global_script.map.preimage_edit.edit_color[count_edit_color].active,GUILayout.Width(25));
			...
			EditorGUILayout.LabelField("Export Active",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			GUI.color = Color.white;
			current_area.preimage_export_active = EditorGUILayout.Toggle(current_area.preimage_export_active,GUILayout.Width(25));
			EditorGUILayout.EndHorizontal();
			
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Save New",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			GUI.color = Color.white;
			current_area.preimage_save_new = EditorGUILayout.Toggle(current_area.preimage_save_new,GUILayout.Width(25));
			EditorGUILayout.EndHorizontal();
			
			if (current_area.preimage_save_new) {
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Export Path",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				EditorGUILayout.LabelField(GUIContent(current_area.preimage_path,current_area.preimage_path),GUILayout.Width(438));
				GUI.color = Color.white;
				...
				current_area.preimage_path_changed = EditorGUILayout.Toggle(current_area.preimage_path_changed,GUILayout.Width(25));
				EditorGUILayout.EndHorizontal();
				
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Image File",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				current_area.preimage_filename = EditorGUILayout.TextField(current_area.preimage_filename,GUILayout.Width(guiWidth2-guiWidth1-4));
				EditorGUILayout.EndHorizontal();
				
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Import Settings",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				global_script.map.preimage_edit.import_settings = EditorGUILayout.Toggle(global_script.map.preimage_edit.import_settings,GUILayout.Width(25));
				EditorGUILayout.EndHorizontal();
			...
			if (GUILayout.Button("Pause",EditorStyles.miniButtonMid,GUILayout.Width(45))) {
			...
			//gui_y += 19*3;
			GUILayout.Space(5); //+count_edit_color);
		}
		...
		if (global_script.map.button_update)
	    {
	    	...
	    	EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Updates",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			gui_changed_old = GUI.changed;
			gui_changed_window = GUI.changed; gui_changed_window = GUI.changed; GUI.changed = false;
			var update_select: int = read_check();
			GUI.color = Color.white;
			update_select = EditorGUILayout.Popup(update_select,global_script.settings.update,GUILayout.Width(202));	    	
			if (GUI.changed)
			{
	    	...
	    	EditorGUILayout.BeginHorizontal();
	    	GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Current Version",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Available Version",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			if (global_script.settings.new_version == 0 || global_script.settings.wc_loading == 1){EditorGUILayout.LabelField("---",GUILayout.Width(80));}
			else {EditorGUILayout.LabelField("Final "+global_script.settings.new_version.ToString("F3"),GUILayout.Width(80));}
			GUILayout.Space(38);
			if (global_script.settings.wc_loading == 1){EditorGUILayout.LabelField("Checking...");}
			if (global_script.settings.wc_loading == 2){EditorGUILayout.LabelField("Downloading...");}
			GUI.color = Color.white;
			...
			if (global_script.settings.update_version2)
			{
		...
		{	
			...
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Map Type",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			gui_changed_old = GUI.changed;
			GUI.changed = false;
			GUI.color = Color.white;
			global_script.map.type = EditorGUILayout.EnumPopup(global_script.map.type,GUILayout.Width(150));
			if (GUI.changed)
			{
				request_map();
			}
			...
			if (GUILayout.Button("K",EditorStyles.miniButtonMid,GUILayout.Width(25)))
			{
			...
			global_script.map.active = EditorGUILayout.Toggle(global_script.map.active,GUILayout.Width(25));
			...
			if (global_script.map.key_edit)
			{
				...
				if (GUILayout.Button("-",EditorStyles.miniButtonMid,GUILayout.Width(25)) && global_script.map.bingKey.Count > 1)
				{
					if (key.control) {
				...
				for (var countKey: int = 0;countKey < global_script.map.bingKey.Count;++countKey)
				{
					EditorGUILayout.BeginHorizontal();
					GUI.color = global_script.map.color;
					EditorGUILayout.LabelField("Bing Key "+countKey.ToString()+" ->",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
					GUI.color = Color.white;
					global_script.map.bingKey[countKey].key = EditorGUILayout.TextField(global_script.map.bingKey[countKey].key,GUILayout.Width(170));
					if (GUILayout.Button("-",EditorStyles.miniButtonMid,GUILayout.Width(25)) && global_script.map.bingKey.Count > 1)
					{
						if (key.control) {
							Undo.RegisterUndo(global_script,"Erase Bing Key");
				...
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Key Selected",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				global_script.map.bingKey_selected = EditorGUILayout.IntField(global_script.map.bingKey_selected,GUILayout.Width(50));
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Latitude ",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			
			gui_changed_old = GUI.changed;
			GUI.changed = false;
			if (global_script.map.manual_edit) {
				GUI.color = Color.white;
				latlong_center.latitude = EditorGUILayout.FloatField(latlong_center.latitude,GUILayout.Width(150));
			}
			else {
				EditorGUILayout.LabelField(latlong_center.latitude.ToString("F7"),GUILayout.Width(150));
			}
			if (GUI.changed)
			{
			...
			GUI.changed = gui_changed_old;
			GUI.color = Color.white;
			if (GUILayout.Button("E",EditorStyles.miniButtonMid,GUILayout.Width(25)))
			{
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Longitude ",EditorStyles.boldLabel,GUILayout.Width(guiWidth1)); 
			gui_changed_old = GUI.changed;
			GUI.changed = false;
			if (global_script.map.manual_edit) {
				GUI.color = Color.white;
				latlong_center.longitude = EditorGUILayout.FloatField(latlong_center.longitude,GUILayout.Width(150));
			}
			else {
				EditorGUILayout.LabelField(latlong_center.longitude.ToString("F7"),GUILayout.Width(150));
			}
			if (GUI.changed)
			{
				global_script.map_latlong_center = latlong_center;
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Zoom ",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			EditorGUILayout.LabelField(zoom.ToString("F2")); 
			EditorGUILayout.EndHorizontal();
			
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Mouse ",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			EditorGUILayout.LabelField(latlong_mouse.latitude.ToString("F5")+", "+latlong_mouse.longitude.ToString("F5"));
			EditorGUILayout.EndHorizontal();
		...
		if (global_script.map.button_region)
		{
			...
			*/
			...
			GUI.changed = false;
			GUI.color = Color.white;
			global_script.map.region_select = EditorGUILayout.Popup(global_script.map.region_select,global_script.map.region_popup,GUILayout.Width(guiWidth1+126));
			if (GUI.changed)
			{
			...
			if (GUILayout.Button("-",EditorStyles.miniButtonMid,GUILayout.Width(25)) && global_script.map.region.Count > 1)
			{
				if (key.control) {
			...
			if (global_script.map.region_popup_edit)
			{
				...
				GUI.changed = false;
				GUI.color = Color.white;
				current_region.name = EditorGUILayout.TextField(current_region.name,GUILayout.Width(210));
			...
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Lat/Long",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			EditorGUILayout.LabelField(current_region.center.latitude.ToString("F4")+", "+current_region.center.longitude.ToString("F4"),GUILayout.Width(122));
			GUI.SetNextControlName ("GoButton");
			GUI.color = Color.white;
			if (GUILayout.Button("Go",EditorStyles.miniButtonMid,GUILayout.Width(30)))
			{
				stop_download();
			...
			if (GUILayout.Button("<Set>",EditorStyles.miniButtonMid,GUILayout.Width(45)) && key.shift)
			{
			...
			*/
			...
			GUI.changed = false;
			GUI.color = Color.white;
			current_region.area_select = EditorGUILayout.Popup(current_region.area_select,current_region.area_popup,GUILayout.Width(guiWidth1+126));
			if (GUI.changed)
			{
			...
			if (GUILayout.Button("-",EditorStyles.miniButtonMid,GUILayout.Width(25)) && current_region.area.Count > 1)
			{
				if (key.control) {
			...
			if (current_region.area.Count >  0)
			{
				if (global_script.map.area_popup_edit)
				{
					...
					GUI.changed = false;
					GUI.color = Color.white;
					current_area.name = EditorGUILayout.TextField(current_area.name,GUILayout.Width(210));
				...
				GUI.color = global_script.map.color;
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Center",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				EditorGUILayout.LabelField(current_area.center.latitude.ToString("G6")+", "+current_area.center.longitude.ToString("G6"),GUILayout.Width(122));
				GUI.SetNextControlName ("GoButton");
				GUI.color = Color.white;
				if (GUILayout.Button("Go",EditorStyles.miniButtonMid,GUILayout.Width(30)))
				{
				...
				if (GUILayout.Button("<Set>",EditorStyles.miniButtonMid,GUILayout.Width(45)))
				{
					if (key.shift) {
				...
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Upper Left",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				EditorGUILayout.LabelField(current_area.upper_left.latitude.ToString("G6")+", "+current_area.upper_left.longitude.ToString("G6"),GUILayout.Width(122));
				GUI.color = Color.white;
				GUI.SetNextControlName ("GoButton");
				// if (GUILayout.Button("E",EditorStyles.miniButtonMid,GUILayout.Width(25)))
				// {
				...
				*/
				...
				if (GUILayout.Button("Pick",EditorStyles.miniButtonMid,GUILayout.Width(45)))
				{
					if (!current_area.export_heightmap_active && !current_area.export_image_active) {
						if (global_script.map.mode != 1)
						{
				...
				if (current_area.manual_area) {
					...
					GUILayout.Space(15);
					GUI.color = global_script.map.color;
					EditorGUILayout.LabelField("Latitude",EditorStyles.boldLabel,GUILayout.Width(guiWidth1-12));
					GUI.color = Color.white;
					current_area.upper_left.latitude = EditorGUILayout.FloatField(current_area.upper_left.latitude,GUILayout.Width(150));
					EditorGUILayout.EndHorizontal(); 
					
					EditorGUILayout.BeginHorizontal(); 
					GUILayout.Space(15);
					GUI.color = global_script.map.color;
					EditorGUILayout.LabelField("Longitude",EditorStyles.boldLabel,GUILayout.Width(guiWidth1-12));
					GUI.color = Color.white;
					current_area.upper_left.longitude = EditorGUILayout.FloatField(current_area.upper_left.longitude,GUILayout.Width(150));
					EditorGUILayout.EndHorizontal(); 
				}
				
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Lower Right",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				...
				EditorGUILayout.LabelField(current_area.lower_right.latitude.ToString("G6")+", "+current_area.lower_right.longitude.ToString("G6"),GUILayout.Width(122));
				GUI.SetNextControlName ("GoButton");
				GUI.color = Color.white;
				if (GUILayout.Button("Go",EditorStyles.miniButtonMid,GUILayout.Width(30)))
				{
				...
				*/
				...
				if (GUILayout.Button("Resize",EditorStyles.miniButtonMid,GUILayout.Width(45)))
				{
				...
				if (current_area.manual_area) {
					...
					EditorGUILayout.LabelField("Latitude",EditorStyles.boldLabel,GUILayout.Width(guiWidth1-12));
					GUI.color = Color.white;
					current_area.lower_right.latitude = EditorGUILayout.FloatField(current_area.lower_right.latitude,GUILayout.Width(150));
					EditorGUILayout.EndHorizontal(); 
					...
					EditorGUILayout.LabelField("Longitude",EditorStyles.boldLabel,GUILayout.Width(guiWidth1-12));
					GUI.color = Color.white;
					current_area.lower_right.longitude = EditorGUILayout.FloatField(current_area.lower_right.longitude,GUILayout.Width(150));
					EditorGUILayout.EndHorizontal(); 
				}
				
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Size",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				EditorGUILayout.LabelField((current_area.size.x/1000).ToString("F2")+"(km), "+(current_area.size.y/1000).ToString("F2")+"(km)",GUILayout.Width(152));
				GUI.color = Color.white;
				if (GUILayout.Button("Edit",EditorStyles.miniButtonMid,GUILayout.Width(45))) 
				{
				...
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Height Center",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				EditorGUILayout.LabelField(current_area.center_height.ToString()+" (m)");
				EditorGUILayout.EndHorizontal();
				
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Heightmap Data",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				EditorGUILayout.LabelField(current_area.elevation_zoom.ToString()+" -> "+current_area.heightmap_scale.ToString("F2")+" (m/p)");
				EditorGUILayout.EndHorizontal();
				GUILayout.Space(3);	
			}	
		}
		...
		{	
			...
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Heightmap Zoom",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			gui_changed_old = GUI.changed;
			GUI.changed = false;
			GUI.color = Color.white;
			current_area.heightmap_zoom = EditorGUILayout.IntField(current_area.heightmap_zoom,GUILayout.Width(60));
			if (GUILayout.Button("+",EditorStyles.miniButtonMid,GUILayout.Width(25)))
			{
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Heightmap Size",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			EditorGUILayout.LabelField(current_area.heightmap_resolution.x.ToString()+"x"+current_area.heightmap_resolution.y.ToString()
				+"  ("+((current_area.heightmap_resolution.x*current_area.heightmap_resolution.y)/1024)+" threads)");
			EditorGUILayout.EndHorizontal();
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.LabelField("Export Path",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			EditorGUILayout.LabelField(GUIContent(current_area.export_heightmap_path,current_area.export_heightmap_path),GUILayout.Width(guiWidth1+19));
			GUI.color = Color.white;
			if (GUILayout.Button("Change",GUILayout.Width(60)))
			{
			...
			if (global_script.map.path_display) {
				...
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField(GUIContent(current_area.export_heightmap_path),EditorStyles.boldLabel);
			}
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Heightmap File",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			GUI.color = Color.white;
			gui_changed_old = GUI.changed;
			GUI.changed = false;
			current_area.export_heightmap_filename = EditorGUILayout.TextField(current_area.export_heightmap_filename,GUILayout.Width(guiWidth1+21));
			if (GUI.changed) {
				current_area.export_heightmap_changed = true;
			...
			GUI.changed = false;
			current_area.export_heightmap_changed = EditorGUILayout.Toggle(current_area.export_heightmap_changed,GUILayout.Width(25));
			if (GUI.changed) {
				if (!current_area.export_heightmap_changed) {
			...
			else if (GUILayout.Button(">",EditorStyles.miniButtonMid,GUILayout.Width(25))) {
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField("Threads",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
			GUI.color = Color.white;
			gui_changed_old = GUI.changed;
			GUI.changed = false;
			global_script.map.export_elExt = EditorGUILayout.IntField(global_script.map.export_elExt,GUILayout.Width(60));
			if (GUI.changed) {
			...
			EditorGUILayout.BeginHorizontal();
			GUI.color = Color.white;
			if (GUILayout.Button(button_text,GUILayout.Width(guiWidth1),GUILayout.Height(38)))
			{
				if (current_area.tiles.x == 0 && current_area.tiles.y == 0) {
		    		this.ShowNotification(GUIContent("The area is not created. Use the 'Pick' button to create an area"));
		    		return;
			...
			GUILayout.Space(14);
			GUI.color = global_script.map.color;
			EditorGUILayout.LabelField(sec_to_timeMin(global_script.map.export_heightmap_timeEnd-global_script.map.export_heightmap_timeStart,true));
			EditorGUILayout.EndHorizontal();
			GUILayout.Space(6);
		}
		...
		{	
				...
				image_export_rect = Rect(0,gui_y,guiWidth2+1,241+gui_height);
				...
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Image Zoom",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				GUI.color = Color.white;
				current_area.image_zoom = EditorGUILayout.IntField(current_area.image_zoom,GUILayout.Width(60));
				if (GUILayout.Button("+",EditorStyles.miniButtonMid,GUILayout.Width(25)))
				{
				...
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Resolution",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				EditorGUILayout.LabelField(current_area.resolution.ToString(),GUILayout.Width(60));
				GUI.color = Color.white;
				if (GUILayout.Button("+",EditorStyles.miniButtonMid,GUILayout.Width(25)))
				{
				...
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Tiles",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				current_area.tiles.x = EditorGUILayout.IntField(current_area.tiles.x,GUILayout.Width(45));
				EditorGUILayout.LabelField("X",GUILayout.Width(15));
				current_area.tiles.y = EditorGUILayout.IntField(current_area.tiles.y,GUILayout.Width(45));
				GUILayout.Space(27);
				if (current_area.start_tile_enabled) {GUI.color = Color.green;}
				if (GUILayout.Button("Start",EditorStyles.miniButtonMid,GUILayout.Width(58)))
				{
				...
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Image Size",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				...
				EditorGUILayout.LabelField((area_size.x).ToString()+"x"+(area_size.y).ToString()
					+"  ("+((area_size.x*area_size.y)/262144)+" threads)");
				EditorGUILayout.EndHorizontal();
				
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Export Path",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				EditorGUILayout.LabelField(GUIContent(current_area.export_image_path,current_area.export_image_path),GUILayout.Width(guiWidth1+19));
				GUI.color = Color.white;
				if (GUILayout.Button("Change",GUILayout.Width(60)))
				{
				...
				if (global_script.map.path_display) {
					...
					GUI.color = global_script.map.color;
					EditorGUILayout.LabelField(GUIContent(current_area.export_image_path),EditorStyles.boldLabel);
				}
				EditorGUILayout.EndHorizontal();
				...
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				current_area.export_image_filename = EditorGUILayout.TextField(current_area.export_image_filename,GUILayout.Width(guiWidth1+21));
				if (GUI.changed) {
					current_area.export_image_changed = true;
					if (!current_area.export_heightmap_changed) {
						current_area.export_heightmap_filename = current_area.export_image_filename;}
				...
				GUI.changed = false;
				current_area.export_image_changed = EditorGUILayout.Toggle(current_area.export_image_changed,GUILayout.Width(25));
				if (GUI.changed) {
					if (!current_area.export_image_changed) {
						current_area.export_image_path = current_area.export_heightmap_path;
						current_area.export_image_filename = current_area.export_heightmap_filename;
				...
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Export World File",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				current_area.export_image_world_file = EditorGUILayout.Toggle(current_area.export_image_world_file,GUILayout.Width(25));
				EditorGUILayout.EndHorizontal();
				...
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				global_script.map.export_texExt = EditorGUILayout.IntField(global_script.map.export_texExt,GUILayout.Width(60));
				if (GUI.changed) {
				...
				EditorGUILayout.LabelField("Import Settings",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				current_area.export_image_import_settings = EditorGUILayout.Toggle(current_area.export_image_import_settings,GUILayout.Width(25));
				if (apply_import_settings) {
					GUI.color = Color.red;
					EditorGUILayout.LabelField(((create_area.tiles.x*create_area.tiles.y)-import_settings_count).ToString(),GUILayout.Width(30));
				}
				EditorGUILayout.EndHorizontal();
				...
				GUI.color = global_script.map.color;
				GUILayout.Space(14);
				EditorGUILayout.LabelField(sec_to_timeMin(global_script.map.export_image_timeEnd-global_script.map.export_image_timeStart,true));
				EditorGUILayout.EndHorizontal();
				
				EditorGUILayout.BeginHorizontal();
				EditorGUILayout.LabelField("Jpg",GUILayout.Width(30));
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				GUI.color = Color.white; 
				global_script.map.export_jpg = EditorGUILayout.Toggle(global_script.map.export_jpg,GUILayout.Width(25));
				if (GUI.changed)
				{
				...
				GUI.changed = false;
				GUI.color = Color.white;
				global_script.map.export_png = EditorGUILayout.Toggle(global_script.map.export_png,GUILayout.Width(25));
				if (GUI.changed)
				{
				...
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Raw",GUILayout.Width(30));
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				GUI.color = Color.white;
				global_script.map.export_raw = EditorGUILayout.Toggle(global_script.map.export_raw,GUILayout.Width(25));
				if (GUI.changed)
				{
				...
				{
					EditorGUILayout.BeginHorizontal();
					EditorGUILayout.LabelField("Jpeg Quality",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
					GUI.color = Color.white;
					// GUI.backgroundColor = Color.white;
					global_script.map.export_jpg_quality = EditorGUILayout.Slider(global_script.map.export_jpg_quality,0,100,GUILayout.Width(guiWidth1+80));
					EditorGUILayout.EndHorizontal();
				}
				...
				if (global_script.map.export_raw)
				{
					...
					if (global_script.map.export_jpg)
					{
						if (GUILayout.Button("Slice Images",GUILayout.Width(120)))
						{
							slice_textures(current_area,current_area.export_image_path,current_area.export_image_filename);
						}
					}
					else if (GUILayout.Button("Combine Images",GUILayout.Width(120)))
					{
		...
		{	
				...
				EditorGUILayout.LabelField("Called Threads",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				
				EditorGUILayout.LabelField("Key"+global_script.map.bingKey_selected+" -> "+global_script.map.bingKey[global_script.map.bingKey_selected].pulls.ToString()+" ("+calc_24_hours()+")",GUILayout.Width(150));
				GUI.color = Color.white;
				...
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Mouse Sensivity",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				GUI.color = Color.white;
				// GUI.backgroundColor = Color.white;
				global_script.map.mouse_sensivity = EditorGUILayout.Slider(global_script.map.mouse_sensivity,1,10,GUILayout.Width(guiWidth1+84));
				EditorGUILayout.EndHorizontal();
										
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Title Color",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				global_script.map.titleColor = EditorGUILayout.ColorField(global_script.map.titleColor,GUILayout.Width(50));
				if (GUI.changed) {
					global_script.tex3.SetPixel(0,0,global_script.map.titleColor);
					global_script.tex3.Apply();
				}
				...
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Background Color",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				gui_changed_old = GUI.changed;
				GUI.changed = false;
				global_script.map.backgroundColor = EditorGUILayout.ColorField(global_script.map.backgroundColor,GUILayout.Width(50));
				if (GUI.changed) {
					global_script.tex2.SetPixel(0,0,global_script.map.backgroundColor);
					global_script.tex2.Apply();
				}
				...
				EditorGUILayout.BeginHorizontal();
				GUI.color = global_script.map.color;
				EditorGUILayout.LabelField("Font Color",EditorStyles.boldLabel,GUILayout.Width(guiWidth1));
				global_script.map.color = EditorGUILayout.ColorField(global_script.map.color,GUILayout.Width(50));
				EditorGUILayout.EndHorizontal();
		}
		
		if (global_script.map.button_image_editor) {
			gui_y2 += 122+(global_script.map.preimage_edit.edit_color.Count*18);
			...
			*/
			...
			if (!current_area.export_to_terraincomposer || !terraincomposer) {
				...
				if (GUI.Button(Rect(guiWidth2+406,301+gui_y2+import_height+tc_height,20,17),"R")) {
					current_area.terrain_curve = new AnimationCurve.Linear(0,0,0.89,0.89);
	...
	*/
	...
	function slice_textures(area1: map_area_class,path: String,file: String) 
	{
		...
		import_file = new FileStream(path+"/"+file+"_combined.raw",FileMode.Open);
	...
	*/
	...
	function set_terrainArea_splat_textures(terrainArea1: terrain_area_class,count_terrain: int) 
	{
		...
		if (!File.Exists(Application.dataPath+"/ReliefPack/Scripts/ReliefTerrain/ReliefTerrain.cs")) {
			...
			// Add RTP if there
			terrainArea1.terrains[count_terrain].rtp_script = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(terrainArea1.terrains[count_terrain].terrain.gameObject, "Assets/TerrainComposer/Editor/Map_tc.js(5057,75)", "ReliefTerrain");
	...
	{
		if (!global_script.map5) {
			global_script.map5 = new Texture2D(800,768);
		}
		if (!global_script.map0){global_script.map0 = new Texture2D(1600,768);}
			
		
		global_script.map.preimage_edit.convert_texture(global_script.map0,global_script.map5,800,768,true);
		
		if (!global_script.map.preimage_edit.generate) {		
			pixels = global_script.map5.GetPixels(0,0,800,768);
			global_script.map0.SetPixels(800,0,800,768,pixels);
	...
	function convert_textures(area1: map_area_class)
	{
		if (convert_texture) {
			global_script.map.preimage_edit.convert_texture(convert_texture,convert_texture,convert_texture.width,convert_texture.height,true);
		}
