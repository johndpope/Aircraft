...
Properties {
    ...
    _BlurCenterX ("", Float) = 0.5
    _BlurCenterY ("", Float) = 0.5
}
    SubShader {
        Pass {
...
#pragma exclude_renderers d3d11 xbox360 gles
    ...
    uniform half _BlurCenterX;
    uniform half _BlurCenterY;
    ...
    half4 frag (v2f_img i) : COLOR {
        ...
        half2 dir = half2(_iWidth*_BlurCenterX,_iHeight*_BlurCenterY)-i.uv;
       	//distance to center
