//UniStorm Weather System Editor C# Version 1.8.4 @ Copyright
...
public class UniStormEditor_C : Editor 
{
	...
	//DayMDropDown editorDayMinute = DayMDropDown._18;
	//NightMDropDown editorNightMinute = NightMDropDown._18;
	...
	public override void OnInspectorGUI () 
	{
		...
		if (self.timeOptions)
		{
			...
			editorDayHour = (DayHourDropDown)EditorGUILayout.EnumPopup("Starting Day Hour", editorDayHour);
			...
			/*
			editorDayMinute = (DayMDropDown)self.dayLengthMinute;
			editorDayMinute = (DayMDropDown)EditorGUILayout.EnumPopup("Starting Day Minute", editorDayMinute);
			self.dayLengthMinute = (int)editorDayMinute;
			*/
			...
			editorNightHour = (NightHourDropDown)EditorGUILayout.EnumPopup("Starting Night Hour", editorNightHour);
			...
			/*
			editorNightMinute = (NightMDropDown)self.nightLengthMinute;
			editorNightMinute = (NightMDropDown)EditorGUILayout.EnumPopup("Starting Night Minute", editorNightMinute);
			self.nightLengthMinute = (int)editorNightMinute;
			*/
		...
		if (self.moonOptions)
		{
			...
			self.moonLightIntensity = EditorGUILayout.Slider ("Normal Moon Intensity", self.moonLightIntensity, 0, 0.5f);

			EditorGUILayout.Space();

			self.stormyMoonLightIntensity = EditorGUILayout.Slider ("Stormy Moon Intensity", self.stormyMoonLightIntensity, 0, 0.5f);
