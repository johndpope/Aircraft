...
public class UniStormMenu : MonoBehaviour {
	...
	[MenuItem ("Window/UniStorm/Documentation/Unity 5 (New)")]
	static void UnityFive ()
	{
		Application.OpenURL("http://unistorm-weather-system.wikia.com/wiki/UniStorm_(Unity_5)");
	}
	...
	[MenuItem ("Window/UniStorm/Beta Features (New)/Test Beta Features")]
